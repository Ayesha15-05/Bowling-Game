# Bowling-Game
Bowling-Game This is a simple 2D bowling game simulation written in the C programming language. It allows up to four players to play a virtual bowling game by entering the angle of their bowling throw. The goal is to make the game feel interactive, track scores across frames.
